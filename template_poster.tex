...
%% \block should be used for "section" and \innerblock for "subsection"





\documentclass{poster} %Options for format can be included here

% Title, Author, Institute
\title{Que se passe-t-il si le titre est très long ?}
\subtitle{Il faut alors mettre un sous-titre !} % Optional
\author{Author(s)}
\institute{Institute}
...
\block{Basic Block}
{
  Text \hfill vraiment ?!? \hfill OK. Fais donc ton test...

\begin{minipage}{.48\linewidth}
    \innerblock{Inner block test 1}
    {This is a test}
\end{minipage}
\hfill
\begin{minipage}{.48\linewidth}
    \innerblock{Inner block test 2}
